...
let UsersController = class UsersController {
    ...
    async findAll(skip, limit, take, username, cursor, email, sort) {
...
__decorate([
    ...
    __param(3, common_1.Query('username')),
    __param(4, common_1.Query('cursor')),
    __param(5, common_1.Query('email')),
    __param(6, common_1.Query('sort')),
    __metadata("design:type", Function),
